...
public class AI : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // changed to public to access in other script
        ...
        machine = new FiniteStateMachine(this);
        machine.SetStartState(new HuntEnemy(machine));
        machine.Start();
    }
    ...
    public bool IsEnemyScoring()
    {
        if (_agentData.EnemyScore > previousScore)
        {
            return true;
        }
        previousScore = _agentData.EnemyScore;
        return false;
    }

    public bool IsFriendlyScoring()
    {
        if (_agentData.FriendlyScore > previousScore)
        {
            return true;
        }
        previousScore = _agentData.FriendlyScore;
        return false;
    }
